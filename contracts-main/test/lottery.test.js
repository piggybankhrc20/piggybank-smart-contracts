...
contract('Lottery', (accounts) => {
    it('init', async () => {
        ...
        this.coink = await MockBEP20.deployed();
        ...
        await this.coink.transfer(bob, '2000', { from: minter });
        await this.coink.transfer(alice, '2000', { from: minter });
        await this.coink.transfer(carol, '2000', { from: minter });
    });
    ...
    it('test', async () => {
        ...
        carol=accounts[3];
        dev=accounts[4];
        await this.coink.approve(this.lotteryProxyAddress, '1000', { from: alice });
        await this.coink.approve(this.lotteryProxyAddress, '1000', { from: bob });
        ...
        assert.equal((await this.coink.balanceOf(this.lotteryProxyAddress)).toString(), '418');
