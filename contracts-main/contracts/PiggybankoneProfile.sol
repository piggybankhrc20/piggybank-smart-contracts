...
// File: @piggybankone/matrixswap-lib/contracts/token/BEP20/IBEP20.sol
...
// File: contracts/PiggybankoneProfile.sol

pragma solidity ^0.6.0;

/** @title PiggybankoneProfile.
@dev It is a contract for users to bind their address 
to a customizable profile by depositing a NFT.
*/
contract PiggybankoneProfile is AccessControl, ERC721Holder {
    using Counters for Counters.Counter;
    using SafeBEP20 for IBEP20;
    using SafeMath for uint256;

    IBEP20 public coinkToken;
    ...
    uint256 public numberCoinkToReactivate;
    uint256 public numberCoinkToRegister;
    uint256 public numberCoinkToUpdate;
    ...
    constructor(
        IBEP20 _coinkToken,
        uint256 _numberCoinkToReactivate,
        uint256 _numberCoinkToRegister,
        uint256 _numberCoinkToUpdate
    ) public {
        coinkToken = _coinkToken;
        numberCoinkToReactivate = _numberCoinkToReactivate;
        numberCoinkToRegister = _numberCoinkToRegister;
        numberCoinkToUpdate = _numberCoinkToUpdate;
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }

    /**
     * @dev To create a user profile. It sends the NFT to the contract
     * and sends COINK to burn address. Requires 2 token approvals.
     */
    function createProfile(
        ...
        // Transfer COINK tokens to this contract
        coinkToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberCoinkToRegister
        );
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        // Transfer COINK token to this address
        coinkToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberCoinkToUpdate
    ...
    /**
     * @dev Claim COINK to burn later.
     * Callable only by owner admins.
     */
    function claimFee(uint256 _amount) external onlyOwner {
        coinkToken.safeTransfer(_msgSender(), _amount);
    }
    ...
    /**
     * @dev Update the number of COINK to register
     * Callable only by owner admins.
     */
    function updateNumberCoink(
        uint256 newNumberCoinkToReactivate,
        uint256 _newNumberCoinkToRegister,
        uint256 _newNumberCoinkToUpdate
    ) external onlyOwner {
        numberCoinkToReactivate = newNumberCoinkToReactivate;
        numberCoinkToRegister = _newNumberCoinkToRegister;
        numberCoinkToUpdate = _newNumberCoinkToUpdate;
    }
